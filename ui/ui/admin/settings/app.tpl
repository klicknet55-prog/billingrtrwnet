    ...
    <div class="panel" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div id="collapseGeneral" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">{Lang::T('Disable Invoice Attribute')}</label>
                    <div class="col-md-5">
                        <select name="disable_invoice_attribute" id="disable_invoice_attribute" class="form-control">
                            <option value="no" {if !isset($_c['disable_invoice_attribute']) || $_c['disable_invoice_attribute']=='no' }selected="selected" {/if}>
                                {Lang::T('No')}
                            </option>
                            <option value="yes" {if isset($_c['disable_invoice_attribute']) && $_c['disable_invoice_attribute']=='yes' }selected="selected" {/if}>
                                {Lang::T('Yes')}
                            </option>
                        </select>
                    </div>
                    <span class="help-block col-md-4">
                        {Lang::T('If enabled, billing will ignore customer Invoice attribute and always use plan price')}
                    </span>
                </div>
                <div class="form-group">
