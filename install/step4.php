...
//error_reporting (0);
$appurl = isset($_POST['appurl']) ? rtrim(trim($_POST['appurl']), '/') : '';
        ...
        <div class="span12">
            ...
            ?>
                <p> MySQL Connection was successfull. An error occured while adding data on MySQL. Unsuccessfull
                    Installation. Please refer manual installation in the website github.com/ibnux/phpnuxbill/wiki or Contact Telegram @klicknet55  for
