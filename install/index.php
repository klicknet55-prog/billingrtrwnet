        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p><strong>Informasi Aplikasi</strong><br>
                    Application Name: BILLINGRTRWNET <br>
                    Aplikasi ini versi MOD <br>
                    Release Date: 30/10/2015<br>
                    Base application: PHPNuxBill [ <a href="https://github.com/hotspotbilling/phpnuxbill" target="_blank">https://github.com/hotspotbilling/phpnuxbill</a> ]<br>
                    Donasi: <br>
                    <img src="img/qris.png" class="img-responsive" alt="QRIS" style="max-width: 140px; margin-top: 8px; height: auto;"><br>
                    <br>
